            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <a href="/page/info?action=flower_form" type="button" class="btn btn-sm btn-default"><i class="fa fa-plus"></i> 新增</a>&nbsp;&nbsp;&nbsp;
                            <button type="button" class="btn btn-sm btn-default" onclick="App.deleteMulti('/flower/info')"><i class="fa fa-trash-o"></i> 删除</button>&nbsp;&nbsp;&nbsp;
...
<script>
    ...
    $(function () {
        var _columns = [
            ...
            {
                "data": function (row, type, val, meta) {
                    var detailUrl = "/flower/info?action=find&id=" + row.fid;
                    var deleteUrl = "/flower/info";
                    return '<button type="button" class="btn btn-sm btn-default" onclick="App.showDetail(\'' + detailUrl + '\');"><i class="fa fa-search"></i> 查看</button>&nbsp;&nbsp;&nbsp;' +
                        '<a href="/flower/info?action=edit&fid=' + row.fid + '" type="button" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i> 编辑</a>&nbsp;&nbsp;&nbsp;' +
                        '<button type="button" class="btn btn-sm btn-danger" onclick="App.deleteSingle(\'' + deleteUrl + '\', \'' + row.fid + '\')"><i class="fa fa-trash-o"></i> 删除</button>';
                }
            }
        ];

        _dataTable = App.initDataTables("/flower/info?action=list", _columns);
